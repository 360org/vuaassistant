...
export function buildSystemPrompt(options: ChatOptions): string {
  let prompt =
    ...
    "When the user asks to update an Agent profile, instructions/guidelines (\"kim chỉ nam\"), or personality (\"soul/tính cách\") (e.g. \"update agent erp expert cho anh kim chỉ nam là...\", \"đổi tính cách agent thành...\"), you MUST call the update_agent_profile tool with { agent_name, instructions, soul, title, description } to update the agent configuration files directly on disk.";
